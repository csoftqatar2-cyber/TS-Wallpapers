...
-- ============================================================================
-- Per-car token (2026-09-03, migrations/20260904_device_token.sql). New names only;
-- inert until cf.settings token_min_version_code.<app_id> is lowered per app.
-- ============================================================================
...
-- 20260907_admin_set_device_block_all.sql: one block switch for every program on the car.
...
-- 20260914_phase3_enforcement_prep.sql: per-app enforce switch (closed), licence_status_v2, token_adoption view.
insert into cf.settings(key, value) values
